...
import com.lmg.vk.automix.AutoMixController
...
class JuceLocalPlayer(
    ...
    private val ticker = object : Runnable {
        override fun run() {
            ...
            com.lmg.vk.engine.AudioReactor.feedJuceBass(
    ...
    private fun maybeLogXRuns() {
        ...
        if (x >= 0) {
            ...
            if (delta >= XRUN_ESCALATE_DELTA && bufferEscalations < MAX_BUFFER_ESCALATIONS) {
                ...
                val mode = com.lmg.vk.engine.AppSettings.audioCompatMode.value
    ...
    private fun maybeSyncPowerSave() {
        val ps = com.lmg.vk.ui.PowerSaveMonitor.active

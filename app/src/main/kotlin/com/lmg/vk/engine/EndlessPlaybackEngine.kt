...
class EndlessPlaybackEngine(
    ...
    suspend fun checkAndRefillIfNeeded(remainingCount: Int = -1, force: Boolean = false): Boolean {
        ...
        if (com.lmg.vk.engine.PlayerController.repeatMode.value != 0 && !force) {
            ...
            val newTracks = withContext(Dispatchers.IO) {
                ...
                if (ctx != null) {
                    ...
                    val isStrictTrackStation = isGlobal &&
                        ...
                        seedPool.isEmpty()
                    val waveRepo = com.lmg.vk.data.local.WaveRepository.getInstance(ctx)
                    ...
                    if (tracks.isEmpty() && seed != null) {
                        ...
                        if (driftSeed != null) {
                            ...
                            if (tracks.isNotEmpty() && isGlobal && refillCtx != null) {
                                ...
                                com.lmg.vk.debug.DebugLog.add("WAVE drift seed -> $driftSeed")
                            }
                        }
                    }
                    ...
                    if (tracks.isEmpty() && seed != null) {
                        ...
                        if (tracks.isNotEmpty() && isGlobal && refillCtx?.seedTrackId != null) {
                            ...
                            com.lmg.vk.debug.DebugLog.add("WAVE station -> personal (dried up)")
                        }
                    }
                    ...
                    if (tracks.isEmpty()) {
                        ...
                        if (genres.isNotEmpty()) {
                            ...
                            if (tracks.isNotEmpty() && isGlobal && refillCtx != null) {
                                ...
                                com.lmg.vk.debug.DebugLog.add("WAVE station -> genre search (dried up)")
                            }
                        }
                    }
                    tracks

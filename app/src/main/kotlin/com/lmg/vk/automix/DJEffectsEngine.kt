...
object DJEffectsEngine {
    ...
    suspend fun crossfadeWithEffects(
        ...
        com.lmg.vk.engine.DjStreamFx.begin(transitionType)
        try {
            for (step in 0..steps) {
                ...
                com.lmg.vk.engine.DjStreamFx.update(progress, outVol)
            ...
            if (transitionType == 5) {
                ...
                com.lmg.vk.engine.DjStreamFx.beginTail()
            ...
            com.lmg.vk.engine.DjStreamFx.stop()
        }
    }
